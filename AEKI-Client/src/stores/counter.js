  ...
  actions: {
    async registerHandler(registerInput) {
      try {
        await axios({
          method: 'post',
          url: 'https://api.luqyanazka.site/pub/register',
          data: registerInput
        })
    ...
    async loginHandler(loginInput) {
      try {
        const { data } = await axios({
          method: 'post',
          url: 'https://api.luqyanazka.site/pub/login',
          data: {
    ...
    async fetchData(page) {
      try {
        const { data } = await axios({
          method: 'get',
          url: 'https://api.luqyanazka.site/pub/products?page=' + page
        })
    ...
    async productDetail(id) {
      try {
        const { data } = await axios({
          method: 'get',
          url: 'https://api.luqyanazka.site/pub/products/' + id
        })
    ...
    async fetchCategory() {
      try {
        const { data } = await axios({
          method: 'get',
          url: 'https://api.luqyanazka.site/pub/categories'
        })
    ...
    async fetchBookmarks() {
      try {
        const { data } = await axios({
          method: 'get',
          url: 'https://api.luqyanazka.site/pub/bookmarks',
          headers: {
    ...
    async addToBookmark(productId) {
      try {
        const { data } = await axios({
          method: 'post',
          url: `https://api.luqyanazka.site/pub/bookmarks/${+productId}`,
    ...
    async doSearch() {
      try {
        ...
        const response = await axios.get(
          `https://api.luqyanazka.site/pub/products?productName=${counterStore.searchQuery}`
        )
